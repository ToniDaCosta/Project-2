...
def top_5_countries():
    ...
    ax.barh(df_world["country"], df_world["world percentage"], label="Occupation Percentage", color="blue")
    ...
    plt.legend()
    plt.savefig("top_5_countries_plot.png")
...
def top_5_grow():
    ...
    plt.savefig("top_5_grow_plot.png")

def top_5_continents():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("top_5_continents_plot.png")
...
def china_vs_india():
    ...
    plt.savefig("area_vs_dens_plot.png")